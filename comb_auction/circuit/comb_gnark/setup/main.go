...
import (
	...
	comb_auction "github.com/cowprotocol/Zk-benchmark/comb_auction/gnark"
)
...
func run() error {
	var circuit comb_auction.Circuit
	...
	fmt.Println("Wrote: comb_auction.g16.vk")
	fmt.Println("Wrote: comb_auction.g16.pk")
	return nil
}
